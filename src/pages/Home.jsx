  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen text-center bg-gradient-to-br from-pink-400 to-indigo-500">
      <h1 className="text-4xl font-bold text-white mb-4 animate-fade-in">
        {user ? `Welcome back, ${user.current.name}!` : 'Welcome to Our Blog!'}
      </h1>
      <p className="text-lg text-white mb-6 animate-fade-in delay-150">
        {user ? "Let's create something amazing today!" : 'Sign up to share your thoughts!'}
      </p>
      <button
      ...
      >
        {user ? 'Start a New Post' : 'Sign Up to Create a Post'}
      </button>
    </div>
  );
};
